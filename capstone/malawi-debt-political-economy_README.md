...
The underlying dataset (`malawi_debt_dataset.csv`) and accompanying data dictionary are not included in this repository. If you would like access to the data, sources, and documentation, please contact me directly.
